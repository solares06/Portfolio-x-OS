...
type MDXElementProps<T extends keyof JSX.IntrinsicElements> = ComponentPropsWithoutRef<T>;

export const MDXComponents = {
  h1: (props: MDXElementProps<"h1">) => (
  ...
  blockquote: (props: MDXElementProps<"blockquote">) => (
  ...
  hr: (props: MDXElementProps<"hr">) => <hr className="my-10 border-gray-200" {...props} />,
};
